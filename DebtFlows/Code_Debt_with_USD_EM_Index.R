...
data <- read.csv("DebtFlows_Short_With_USD_EM_Index.csv",header=T,sep=",",stringsAsFactors = FALSE)
...
colnames(overall_merged_main) <- c("period","Short Term W Index", "Medium Term W Index", "Long Term W Index", "Total W Index")
